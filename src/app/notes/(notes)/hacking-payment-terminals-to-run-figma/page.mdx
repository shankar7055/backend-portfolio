...
<Image src="/notes/payment-terminal/update_devices_os.png" width={1280} height={954} sizes="100vw" alt="Image" className="bg-gray-100 rounded-sm object-cover mb-6" />

Okay, let's run it with an older version of the app and install it via USB.

<Image src="/notes/payment-terminal/figma-sign-in.png" width={1280} height={954} sizes="100vw" alt="Image" className="bg-gray-100 rounded-sm object-cover mb-6" />

Success! The app was installed successfully. Now I just have to sign in ...

<Image src="/notes/payment-terminal/browser-error-message.png" width={1280} height={954} sizes="100vw" alt="Image" className="bg-gray-100 rounded-sm object-cover mb-6" />
...
<Image src="/notes/payment-terminal/home-page.png" width={1280} height={954} sizes="100vw" alt="Image" className="bg-gray-100 rounded-sm object-cover mb-6" />

Now for the easy part. I just had to open my design file and ...

## The Major Problem

<Image src="/notes/payment-terminal/os-dead.png" width={1280} height={954} sizes="100vw" alt="Image" className="bg-gray-100 rounded-sm object-cover mb-6" />
