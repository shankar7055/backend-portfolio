      ...
      <div ref={constraintsRef} className="absolute flex items-center justify-center w-[3200px] h-[2760px] left-[50%] top-[50%] -translate-x-[50%] -translate-y-[50%]">
        ...
        >
          ...
          <div className="absolute grid gap-4 grid-cols-[repeat(8,360px)] grid-rows-[repeat(7,360px)] w-[2992px] h-[2620px] left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2">
            ...
            <Image draggable="false" className="select-none relative col-start-6 row-start-4 right-[60px] rotate-[-18deg] right-[230px] bottom-[80px] " width={160} height={160} src="/about-me/stickers/Ken.png" alt="Profile example" />

            <Image draggable="false" className="shadow-lg select-none relative col-start-7 row-start-1 right-[60px] rotate-[9deg] left-[400px]" width={160} height={159} src="/about-me/stickers/brazil-stamp.png" alt="Profile example" />

            <div className="orchestration select-none flex flex-col gap-2 relative rounded-lg w-[90vw] max-w-[100vw] col-start-4 row-start-4 col-span-2 row-span-2 left-1/2 -translate-x-1/2 bottom-[264px] sm:w-[568px] sm:left-[80px] sm:translate-x-0 sm:bottom-[220px] shadow-lg h-fit">
              <div style={{ "--stagger": 1 } as React.CSSProperties} className="select-none flex flex-col gap-2 sm:gap-4 bg-component relative rounded-lg w-full max-w-[100vw] col-span-2 row-span-2 sm:w-[568px] shadow-lg p-6 h-fit ">
                ...
                <div className="flex flex-col gap-4">
                  ...
                  <p className="text-sm sm:text-base">Growing up, I spent hours playing Street Fighter, Donkey Kong, and Super Mario in a Super Nintendo with my dad, and somewhere between levels, I developed high expectations for how interactions should feel. </p>

                  <p className="text-base leading-relaxed">Have fun exploring my portfolio, and feel free to connect below.</p>
                ...
                <Separator className="grow shrink mix-blend-multiply dark:mix-blend-lighten !bg-transparent !h-0 !border-t-[1px] !border-dashed !border-border"></Separator>
            ...
            <div className="select-none flex flex-col gap-2 relative rounded-lg w-[90vw] max-w-[100vw] col-start-4 row-start-7 col-span-2 row-span-2 left-1/2 -translate-x-1/2 sm:w-[568px] sm:left-[80px] sm:translate-x-0 bottom-[480px] shadow-lg h-fit">
            ...
            <div className="select-none relative col-start-4 row-start-3 w-[220px] h-[220px] shadow-2xl rounded-2xl overflow-hidden bottom-[140px] left-[40px] rotate-[4deg] ">
            ...
            <Image draggable="false" className="pointer-events-none select-none relative col-start-4 row-start-5 right-[200px] top-[200px]" width={92} height={80} src="/about-me/stickers/vercel.png" alt="Profile example" />

            <Image draggable="false" className="rotate-[10deg] pointer-events-none select-none relative col-start-8 row-start-6 right-[240px]" width={321} height={86} src="/about-me/stickers/next-js.png" alt="Profile example" />

            <Image draggable="false" className="select-none pointer-events-none relative col-start-7 row-start-6 top-[200px] right-[160px]" width={160} height={142} src="/about-me/stickers/react.png" alt="Profile example" />

            <Image draggable="false" className="select-none pointer-events-none relative col-start-3 row-start-6 bottom-[140px] right-[240px] rotate-[36deg]" width={98} height={160} src="/about-me/stickers/mario.png" alt="Profile example" />
            ...
            <div className="select-none w-fit h-fit relative col-start-3 row-start-1 rotate-[14deg] top-[180px] left-[240px] [perspective:600px]">
            ...
            <div className="select-none w-fit h-fit relative col-start-5 row-start-2 top-[200px] left-[130px] rotate-[75deg] [perspective:600px]">
            ...
            <div className="select-none w-fit h-fit relative col-start-2 row-start-4 rotate-[6deg] [perspective:600px]">
            ...
            <div className="select-none w-fit h-fit relative col-start-4 row-start-2 rotate-[-16deg] top-[10px] left-[320px] [perspective:600px]">
            ...
            <div className="select-none w-fit h-fit relative col-start-1 row-start-5 rotate-[12deg] left-[140px] top-[200px] [perspective:600px]">
            ...
            <div className="select-none w-fit h-fit relative col-start-6 row-start-6 rotate-[-14deg] left-[140px] bottom-[80px] [perspective:600px]">
            ...
            <div className="select-none w-fit h-fit relative col-start-7 row-start-4 rotate-[18deg] left-[120px] [perspective:600px]">
            ...
            <div className="select-none w-fit h-fit relative col-start-4 row-start-6 rotate-[-12deg] top-[280px] [perspective:600px]">
            ...
            <div className="select-none w-fit h-fit relative col-start-6 row-start-7 rotate-[8deg] [perspective:600px]">
            ...
            <div className="select-none w-fit h-fit relative col-start-3 row-start-6 rotate-[-18deg] [perspective:600px]">
              <Book href="/book1.jpg" imageUrl="/about-me/books/nier_art.jpg" width={143} height={198} backCoverColor="bg-[#485556]" title="NieR: Art" />
            </div>

            <div className="select-none w-fit h-fit relative col-start-1 row-start-3 rotate-[10deg] left-[140px] [perspective:600px]">
              <Book href="/book1.jpg" imageUrl="/about-me/books/mega_man.jpg" width={143} height={201} backCoverColor="bg-[#1983FC]" title="Mega Man" />
            </div>

            <div className="select-none w-fit h-fit relative col-start-3 row-start-7 rotate-[-6deg] [perspective:600px]">
