...
export default function Home() {
  return (
    <article>
      ...
      <ImageComponent width={2000} height={1433} className="bg-white " src="/projects/lumini/home.png" alt="" />
      ...
      <div className="flex flex-col gap-8 mb-4">
        <div className="flex flex-row gap-8">
          <img className="size-20 sm:w-40 sm:h-40 border-none" src="../projects/lumini/Ilustration-1.svg" alt="" />
        ...
        <div className="flex flex-row gap-8">
          <img className="size-20 sm:w-40 sm:h-40 border-none" src="../projects/lumini/Ilustration-2.svg" alt="" />
          <div className="content-center">
        ...
        <div className="flex flex-row gap-8">
          <img className="size-20 sm:w-40 sm:h-40 border-none" src="../projects/lumini/Ilustration-3.svg" alt="" />
          <div className="content-center">
        ...
        <div className="flex flex-row gap-8">
          <img className="size-20 sm:w-40 sm:h-40 border-none" src="../projects/lumini/Ilustration-4.svg" alt="" />
          <div className="content-center">
