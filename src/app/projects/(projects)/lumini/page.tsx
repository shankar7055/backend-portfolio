...
export default function Home() {
  return (
    <article>
      ...
      <ImageComponent width={1280} height={900} className="bg-white" src="/projects/lumini/home.png" alt="Lumini mobile app home screen with pink gradient and logo" />
      ...
      <ImageComponent width={2000} height={1112} src="/projects/lumini/Overview_lumini-p-2000.png" alt="Lumini app overview showing career guidance features and interface" />
      ...
      <ImageComponent width={1260} height={874} src="/projects/lumini/group-photo.png" alt="Group photo of students participating in Lumini user research sessions" />
      ...
      <div className="flex flex-col gap-8 mb-4">
        <div className="flex flex-row gap-8">
          <Image unoptimized className="size-20 sm:w-40 sm:h-40 border-none" src="/projects/lumini/Ilustration-1.svg" alt="Illustration of person with multiple interests struggling to choose career path" width={290} height={272} />
        ...
        <div className="flex flex-row gap-8">
          <Image unoptimized className="size-20 sm:w-40 sm:h-40 border-none" src="/projects/lumini/Ilustration-2.svg" alt="Illustration representing online career quizzes and superficial information" width={290} height={272} />
          <div className="content-center">
        ...
        <div className="flex flex-row gap-8">
          <Image unoptimized className="size-20 sm:w-40 sm:h-40 border-none" src="/projects/lumini/Ilustration-3.svg" alt="Illustration of student who has never visited a university" width={290} height={272} />
          <div className="content-center">
        ...
        <div className="flex flex-row gap-8">
          <Image unoptimized className="size-20 sm:w-40 sm:h-40 border-none" src="/projects/lumini/Ilustration-4.svg" alt="Illustration of confident student who has made career decision" width={290} height={272} />
          <div className="content-center">
