...
export default function Home() {
  ...
  return (
    <article>
      ...
      <img src="../projects/stone-link/stone-link_home.png" alt="" />
      ...
      <img src="../projects/stone-link/stone-link_first_section.png" alt="" />
      ...
      <img src="../projects/stone-link/stone-link_research.png" alt="" />
      ...
      <div className="flex flex-col gap-8 mb-4">
        <div className="flex flex-row gap-8">
          <img className="size-20 sm:w-40 sm:h-40 rounded-full" src="../projects/stone-link/Illustration1.svg" alt="" />
        ...
        <div className="flex flex-row gap-8">
          <img className="size-20 sm:w-40 sm:h-40 rounded-full" src="../projects/stone-link/Illustration2.svg" alt="" />
          <div className="content-center">
        ...
        <div className="flex flex-row gap-8">
          <img className="size-20 sm:w-40 sm:h-40 rounded-full" src="../projects/stone-link/Illustration3.svg" alt="" />
          <div className="content-center">
        ...
        <div className="flex flex-row gap-8">
          <img className="size-20 sm:w-40 sm:h-40 rounded-full" src="../projects/stone-link/Illustration4.svg" alt="" />
          <div className="content-center">
      ...
      <img src="../projects/stone-link/stone-link_framework.png" alt="" />
