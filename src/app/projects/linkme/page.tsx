  ...
  return (
    ...
    <div className="w-full pb-24 flex flex-col max-w-3xl p-6 gap-4 sm:gap-8 sm:pt-16 sm:px-12 sm:pb-24 self-center">
      <article>
        ...
        <VideoComponent src="../projects/linkme/Intro-Sales-1-transcode.mp4 " />
        ...
        <VideoComponent src="../projects/linkme/Desktop-Linkme-1-transcode.mp4" />
        ...
        <VideoComponent src="../projects/linkme/Anticipation-1-transcode.mp4" />
